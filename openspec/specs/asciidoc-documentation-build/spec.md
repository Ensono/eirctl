...
Define the canonical AsciiDoc documentation sources, reproducible HTML/PDF build contract, rendered-output validation, and pull-request regression checks for eirctl documentation.
