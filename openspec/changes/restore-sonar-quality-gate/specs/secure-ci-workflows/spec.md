...
#### Scenario: Remediated trusted main revision passes
- **WHEN** all authenticated Critical findings selected as gate blockers are remediated and the resulting exact revision is analyzed by the trusted-main workflow
